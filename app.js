...
app.get('/knjige/dodaj',async (req,res)=>
{
    ...
    {
        console.log(zanrovi);
        res.render('knjige/dodaj',{zanrovi:zanrovi});
    })
})
...
{
        var korisnik=await korisnici.prijava(req.body.email,req.body.lozinka);
...
app.get('/knjige',async (req,res)=>
{
    ...
    res.render('knjige/lista',{knjige:sve_knjige})
})
...
app.get('/bibliotekar/iznajmi/:id_primerka_knjige?',async (req,res)=>
{
    ...
    res.render('bibliotekar/iznajmi',{id_primerka_knjige:id_primerka_knjige});
})
...
app.post('/bibliotekar/iznajmi_potrvrda/:id_korisnia/:id_primerka_knjige',async (req,res)=>
{
    if(!req.session.korisnik_id)
    {
        res.redirect('/login');
...
app.get('/knjige/info/:id_knjige',async (req,res)=>
{
    ...
    res.render('knjige/knjiga_info',{knjiga:knjiga[0],primerci:primerci});
})
